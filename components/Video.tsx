            ...
            <div className="flex flex-col gap-3 mb-8">
              {["Más de 5,000 viajes exitosos realizados","Equipo de asesores certificados disponible 24/7","Garantía de mejor precio del mercado peruano"].map((t) => (
                <div key={t} className="flex items-start gap-2.5">
                  ...
                  <span className="text-[15px] text-[#0c3265] font-medium">{t}</span>
                </div>
              ))}
            </div>
            <a href={WA_LINK} target="_blank" rel="noopener" className="inline-flex items-center gap-2 bg-gradient-to-br from-[#d30000] to-[#e52020] text-white px-8 py-4 rounded-full text-[15px] font-extrabold shadow-[0_6px_28px_rgba(232,64,37,.45)] hover:-translate-y-0.5 hover:shadow-[0_10px_36px_rgba(232,64,37,.55)] transition">
