...
const ITEMS = [
  ...
  { icon: <PlaneIcon className="w-6 h-6 fill-none stroke-[#0a1628] stroke-[1.5]" />, numero: "5,000+", titulo: "Viajes realizados", desc: "Miles de peruanos ya viajaron con nosotros." },
