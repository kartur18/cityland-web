            ...
            <div className="flex flex-col md:flex-row items-stretch gap-3">
              ...
              <div className="hidden lg:flex flex-1 border border-gray-200 rounded-xl px-4 py-3 bg-gray-50/50 items-center">
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <svg viewBox="0 0 24 24" className="w-4 h-4 text-gray-400 fill-none stroke-current stroke-2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
                    <span className="text-[15px] text-gray-400">Flexibles</span>
                  </div>
                </div>
              </div>
