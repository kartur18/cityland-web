...
const SERVICIOS = [
  { titulo: "Vuelos internacionales", desc: "LATAM, Iberia, Copa, Avianca y más. Ida y vuelta, solo ida o multidestino.", color: "bg-blue-500", bg: "bg-blue-50", icon: <PlaneIcon className="w-5 h-5 fill-none stroke-blue-500 stroke-2" /> },
  ...
  { titulo: "Paquetes migratorios", desc: `Boleto, seguro Schengen, retorno flexible y documentación desde $${PRECIO_DESDE_EUROPA}.`, color: "bg-red-500", bg: "bg-red-50", icon: <svg viewBox="0 0 24 24" className="w-5 h-5 fill-none stroke-red-500 stroke-2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg> },
