...
export default function CookieBar() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[9998] bg-[#0c3265] text-white/85 px-6 py-4 flex items-center justify-between gap-4 flex-wrap shadow-[0_-4px_20px_rgba(0,0,0,.2)] text-[13px]">
